...
from models.modules.embedding import SinePositionalEmbedding, TokenEmbedding
    ...
    def forward(
        ...
        **kwargs,
        ...
        if train_stage in [0, 1]:
            ...
            xy_attn_mask = xy_attn_mask.unsqueeze(0).logical_or(_xy_padding_mask)
        ...
        if train_stage == 0:
            total_loss = total_loss / 2.0
        if return_logits:
            return ((x, codes), total_loss, metrics, logits)
        else:
            return ((x, codes), total_loss, metrics)
